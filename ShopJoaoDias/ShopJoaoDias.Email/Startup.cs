...
using ShopJoaoDias.Email.MessageConsumer;
using ShopJoaoDias.Email.Model.Context;
using ShopJoaoDias.Email.Repository;

namespace ShopJoaoDias.Email
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ShopJoaoDias.Email", Version = "v1" });
